...
type
  ...
  private
    ...
    FControllerEntityPedido: IControllerEntity<TPedido>;
...
function TController.Pedido: IControllerEntity<TPedido>;
begin
  if not Assigned(FControllerEntityPedido) then
    FControllerEntityPedido := TControllerEntity<TPedido>.New(Self);
  result := FControllerEntityPedido;
end;
